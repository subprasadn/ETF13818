...
public class Xls_Reader {
	...
	// retrun all column data
	public ArrayList<String> extractExcelContentByColumnIndex(String sheetName, String colName) {
		ArrayList<String> data = new ArrayList<String>();
		for (int i = 2; i <= getRowCount(sheetName); i++) {

			if (!(getCellData(sheetName, colName, i).equalsIgnoreCase(""))) {

				String val = getCellData(sheetName, colName, i);
