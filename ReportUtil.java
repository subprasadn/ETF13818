	...
	public static void startTesting(String filename,String testStartTime,String env,String rel)
	  {
        ...
        String RUN_DATE = Utils.now("dd.MMMMM.yyyy").toString();
	    ...
	    out.write("</head>\n");
	     ...
	     out.write("<body>\n");
	     //out.write("<h4 align=center><div id='content'><img src='C://HybridFramework//src//Data//Sonatalogo.jpg' alt='HTML5 Icon' style='width:28px;height:128px;' /><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> Automation Test Results</u></b></div></h4>\n");
	     out.write("<h4 align=center><div id='content'><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> Automation Test Results</u></b></div></h4>\n");
	     out.write("<style> #content img { float: left; } </style>");
			...
			// out.newLine();
		     ...
		     if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
		       ...
		       //out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+".html>"+testCaseName+"</a></b></td>\n");
		    	 ...
		    	 out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href=./"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+".html>"+testCaseName+"</a></b></td>\n");
		    	 tcid++;
